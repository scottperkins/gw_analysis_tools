...
{\footnotesize template$<$class T $>$ }\\T \mbox{\hyperlink{util_8cpp_ab4e6e8330f62c234ad74029f6d87fb08}{fcontact}} (T M\+\_\+detector, T DL, std\+::string cosmology)
\begin{DoxyCompactList}\small\item\em Rough threshold for when to truncate waveforms for neutron stars. \end{DoxyCompactList}\item 
\mbox{\Hypertarget{util_8cpp_a5b3080dc69b13d1535febd3bbe29a1d3}\label{util_8cpp_a5b3080dc69b13d1535febd3bbe29a1d3}} 
template double {\bfseries fcontact$<$ double $>$} (double, double, std\+::string)
\item 
\mbox{\Hypertarget{util_8cpp_af5df57487782c1fe95a23e814f532101}\label{util_8cpp_af5df57487782c1fe95a23e814f532101}} 
template adouble {\bfseries fcontact$<$ adouble $>$} (adouble, adouble, std\+::string)
\item 
...
\item 
{\footnotesize template$<$class T $>$ }\\void \mbox{\hyperlink{util_8cpp_a52ba97982df939cea3191098152fbbb2}{list\+\_\+intersect\+\_\+value}} (T $\ast$A, int lenA, T $\ast$B, int lenB, T $\ast$C, int $\ast$lenC)
\begin{DoxyCompactList}\small\item\em Custom list-\/interesction implementation for sorted lists. \end{DoxyCompactList}\item 
\mbox{\Hypertarget{util_8cpp_a6595995bb36502886b5790314ab1c855}\label{util_8cpp_a6595995bb36502886b5790314ab1c855}} 
template void {\bfseries list\+\_\+intersect\+\_\+value$<$ double $>$} (double $\ast$, int, double $\ast$, int, double $\ast$, int $\ast$)
\item 
\mbox{\Hypertarget{util_8cpp_adac1189401a0dbb723d0e2aac2316bc7}\label{util_8cpp_adac1189401a0dbb723d0e2aac2316bc7}} 
template void {\bfseries list\+\_\+intersect\+\_\+value$<$ adouble $>$} (adouble $\ast$, int, adouble $\ast$, int, adouble $\ast$, int $\ast$)
\item 
\mbox{\Hypertarget{util_8cpp_a56ca227b8f67a76bb2d163d7367e1b46}\label{util_8cpp_a56ca227b8f67a76bb2d163d7367e1b46}} 
template void {\bfseries list\+\_\+intersect\+\_\+value$<$ int $>$} (int $\ast$, int, int $\ast$, int, int $\ast$, int $\ast$)
\item 
\mbox{\Hypertarget{util_8cpp_a4f15abfb33a16347c3a5075ecc538f90}\label{util_8cpp_a4f15abfb33a16347c3a5075ecc538f90}} 
{\footnotesize template$<$class T , class U $>$ }\\void {\bfseries mean\+\_\+list} (T $\ast$list, int length, U $\ast$result)
\item 
\mbox{\Hypertarget{util_8cpp_af9fe524b141394cf45ba47e6361691ef}\label{util_8cpp_af9fe524b141394cf45ba47e6361691ef}} 
template void {\bfseries mean\+\_\+list$<$ double, double $>$} (double $\ast$, int, double $\ast$)
\item 
\mbox{\Hypertarget{util_8cpp_a3218486cca25a57adb345d3000ca16d9}\label{util_8cpp_a3218486cca25a57adb345d3000ca16d9}} 
template void {\bfseries mean\+\_\+list$<$ adouble, adouble $>$} (adouble $\ast$, int, adouble $\ast$)
\item 
\mbox{\Hypertarget{util_8cpp_afc4518e207d862135630fc2e8f71dc4c}\label{util_8cpp_afc4518e207d862135630fc2e8f71dc4c}} 
template void {\bfseries mean\+\_\+list$<$ int, double $>$} (int $\ast$, int, double $\ast$)
\item 
\mbox{\Hypertarget{util_8cpp_a780768aff48b34c18fe5f7df34925683}\label{util_8cpp_a780768aff48b34c18fe5f7df34925683}} 
template void {\bfseries mean\+\_\+list$<$ int, adouble $>$} (int $\ast$, int, adouble $\ast$)
\item 
\mbox{\Hypertarget{util_8cpp_a99af76e92067fd1c15173a95bcf8fd67}\label{util_8cpp_a99af76e92067fd1c15173a95bcf8fd67}} 
{\footnotesize template$<$class T , class U $>$ }\\void {\bfseries variance\+\_\+list} (T $\ast$list, int length, U $\ast$result)
\item 
\mbox{\Hypertarget{util_8cpp_a811b5a8cf814f4664f2a0ec7d63faef2}\label{util_8cpp_a811b5a8cf814f4664f2a0ec7d63faef2}} 
template void {\bfseries variance\+\_\+list$<$ double, double $>$} (double $\ast$, int, double $\ast$)
\item 
\mbox{\Hypertarget{util_8cpp_aba869001fc8e14ba718e128fdb20f175}\label{util_8cpp_aba869001fc8e14ba718e128fdb20f175}} 
template void {\bfseries variance\+\_\+list$<$ adouble, adouble $>$} (adouble $\ast$, int, adouble $\ast$)
\item 
\mbox{\Hypertarget{util_8cpp_acbbe721697035cb7198079343678dfdd}\label{util_8cpp_acbbe721697035cb7198079343678dfdd}} 
template void {\bfseries variance\+\_\+list$<$ int, double $>$} (int $\ast$, int, double $\ast$)
\item 
\mbox{\Hypertarget{util_8cpp_aeb4fa13bbdfa288408f0f146a6614f44}\label{util_8cpp_aeb4fa13bbdfa288408f0f146a6614f44}} 
template void {\bfseries variance\+\_\+list$<$ int, adouble $>$} (int $\ast$, int, adouble $\ast$)
\item 
...
\item 
\mbox{\Hypertarget{util_8cpp_a5649be3fe6432b46c1fb0041f4a56eb7}\label{util_8cpp_a5649be3fe6432b46c1fb0041f4a56eb7}} 
{\footnotesize template$<$class T $>$ }\\T {\bfseries gps\+\_\+to\+\_\+\+G\+M\+S\+T\+\_\+radian} (T gps\+\_\+time)
\item 
\mbox{\Hypertarget{util_8cpp_ab41d8e6721c9d4df174abadd959d16fa}\label{util_8cpp_ab41d8e6721c9d4df174abadd959d16fa}} 
template double {\bfseries gps\+\_\+to\+\_\+\+G\+M\+S\+T\+\_\+radian$<$ double $>$} (double)
\item 
...
\item 
void \mbox{\hyperlink{util_8cpp_afe7aa670256d4d44a05227b56b48601e}{decimal\+\_\+to\+\_\+\+H\+MS}} (double decimal, int $\ast$hour, int $\ast$min, double $\ast$second)
\begin{DoxyCompactList}\small\item\em Converts decimal into hours, minutes and seconds. \end{DoxyCompactList}\item 
...
\mbox{\Hypertarget{util_8cpp_afe7aa670256d4d44a05227b56b48601e}\label{util_8cpp_afe7aa670256d4d44a05227b56b48601e}} 
\index{util.cpp@{util.cpp}!decimal\_to\_HMS@{decimal\_to\_HMS}}
\index{decimal\_to\_HMS@{decimal\_to\_HMS}!util.cpp@{util.cpp}}
\doxysubsubsection{\texorpdfstring{decimal\_to\_HMS()}{decimal\_to\_HMS()}}
{\footnotesize\ttfamily void decimal\+\_\+to\+\_\+\+H\+MS (\begin{DoxyParamCaption}\item[{double}]{decimal,  }\item[{int $\ast$}]{hour,  }\item[{int $\ast$}]{min,  }\item[{double $\ast$}]{second }\end{DoxyParamCaption})}



Converts decimal into hours, minutes and seconds. 

I just got tired of keeping all these steps straight.. \mbox{\Hypertarget{util_8cpp_aa66116cc2ddd8ba609a68a4c0cdca635}\label{util_8cpp_aa66116cc2ddd8ba609a68a4c0cdca635}} 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{util_8cpp_ab4e6e8330f62c234ad74029f6d87fb08}\label{util_8cpp_ab4e6e8330f62c234ad74029f6d87fb08}} 
\index{util.cpp@{util.cpp}!fcontact@{fcontact}}
\index{fcontact@{fcontact}!util.cpp@{util.cpp}}
\doxysubsubsection{\texorpdfstring{fcontact()}{fcontact()}}
{\footnotesize\ttfamily template$<$class T $>$ \\
T fcontact (\begin{DoxyParamCaption}\item[{T}]{M\+\_\+detector,  }\item[{T}]{DL,  }\item[{std\+::string}]{cosmology }\end{DoxyParamCaption})}
...
24 km separation 
\begin{DoxyParams}{Parameters}
{\em M\+\_\+detector} & Detector frame total mass in seconds \\
\hline
{\em DL} & Luminsosity distance in seconds \\
\hline
{\em cosmology} & Cosmology to use for getting the redshift from dl \\
\hline
\end{DoxyParams}
...
W\+I\+LL N\+OT work in-\/place, A, B, and C must be separate \mbox{\Hypertarget{util_8cpp_a52ba97982df939cea3191098152fbbb2}\label{util_8cpp_a52ba97982df939cea3191098152fbbb2}} 
\index{util.cpp@{util.cpp}!list\_intersect\_value@{list\_intersect\_value}}
\index{list\_intersect\_value@{list\_intersect\_value}!util.cpp@{util.cpp}}
\doxysubsubsection{\texorpdfstring{list\_intersect\_value()}{list\_intersect\_value()}}
{\footnotesize\ttfamily template$<$class T $>$ \\
void list\+\_\+intersect\+\_\+value (\begin{DoxyParamCaption}\item[{T $\ast$}]{A,  }\item[{int}]{lenA,  }\item[{T $\ast$}]{B,  }\item[{int}]{lenB,  }\item[{T $\ast$}]{C,  }\item[{int $\ast$}]{lenC }\end{DoxyParamCaption})}
