...
void \mbox{\hyperlink{fisher_8cpp_aef9f0047c95d3eb691242b60df9a5d4f}{fisher\+\_\+autodiff}} (double $\ast$frequency, int length, std\+::string generation\+\_\+method, std\+::string detector, double $\ast$$\ast$output, int dimension, \mbox{\hyperlink{classgen__params}{gen\+\_\+params}} $\ast$parameters, std\+::string integration\+\_\+method, double $\ast$weights, bool log10\+\_\+f, double $\ast$noise, int $\ast$amp\+\_\+tapes, int $\ast$phase\+\_\+tapes)
\begin{DoxyCompactList}\small\item\em Calculates the fisher matrix for the given arguments to within numerical error using automatic differention -\/ slower than the numerical version. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{fisher_8cpp_a4a22d78a622d1a942e6e93c91fbb0999}{calculate\+\_\+derivatives\+\_\+autodiff}} (double $\ast$frequency, int length, int dimension, std\+::string generation\+\_\+method, \mbox{\hyperlink{classgen__params}{gen\+\_\+params}} $\ast$parameters, std\+::complex$<$ double $>$ $\ast$$\ast$waveform\+\_\+deriv, int $\ast$waveform\+\_\+tapes, std\+::string detector, bool autodiff\+\_\+time\+\_\+deriv)
...
\mbox{\Hypertarget{fisher_8cpp_ad1e1f85b3af98f868772ea95d47d33c0}\label{fisher_8cpp_ad1e1f85b3af98f868772ea95d47d33c0}} 
...
\begin{DoxyCompactItemize}
\item 
\mbox{\Hypertarget{fisher_8cpp_a0f05f1cfa99eff9341f401063e3e551c}\label{fisher_8cpp_a0f05f1cfa99eff9341f401063e3e551c}} 
double {\bfseries L\+O\+G10} =log(10.)
\end{DoxyCompactItemize}


\doxysubsection{Function Documentation}
\mbox{\Hypertarget{fisher_8cpp_a4a22d78a622d1a942e6e93c91fbb0999}\label{fisher_8cpp_a4a22d78a622d1a942e6e93c91fbb0999}} 
...
{\footnotesize\ttfamily void fisher\+\_\+autodiff (\begin{DoxyParamCaption}\item[{double $\ast$}]{frequency,  }\item[{int}]{length,  }\item[{std\+::string}]{generation\+\_\+method,  }\item[{std\+::string}]{detector,  }\item[{double $\ast$$\ast$}]{output,  }\item[{int}]{dimension,  }\item[{\mbox{\hyperlink{classgen__params}{gen\+\_\+params}} $\ast$}]{parameters,  }\item[{std\+::string}]{integration\+\_\+method,  }\item[{double $\ast$}]{weights,  }\item[{bool}]{log10\+\_\+f,  }\item[{double $\ast$}]{noise,  }\item[{int $\ast$}]{amp\+\_\+tapes,  }\item[{int $\ast$}]{phase\+\_\+tapes }\end{DoxyParamCaption})}
...
Note\+: If trying to run large number of Fishers concurrently with openmp, you may need to change some A\+D\+O\+L-\/C parameters. Copy the example .adolcrc file in data/ to the working directory and adjust as needed

If integration method is gaussian quadrature and the frequencies are !\+N\+U\+LL, the weights must be pre-\/allocated.

If the integration method is Newton-\/\+Cotes, the weights are not used.

Integration schemes\+:

Newton-\/\+Cotes methods\+: \begin{DoxyVerb}SIMPSONS
\end{DoxyVerb}


Gaussian Quadrature \begin{DoxyVerb}GAUSSLEG
\end{DoxyVerb}


log10\+\_\+f used if frequencies are logarithmically (base 10) spaced. N\+O\+TE\+: not sure if this would work for S\+I\+M\+P\+S\+O\+NS -- this hasn\textquotesingle{}t been tested. For now, only gaussian quadrature routines are supported. 
...
\hline
{\em parameters} & Injection parameters \\
\hline
{\em integration\+\_\+method} & Method of integration to use \\
\hline
{\em weights} & If using a gaussian quadrature method and the weights have been precomputed, the weights can be supplied here \\
\hline
{\em log10\+\_\+f} & Boolean for logarithmically (base 10) spaced frequencies \\
\hline
{\em noise} & Precomputed P\+SD array \\
\hline
