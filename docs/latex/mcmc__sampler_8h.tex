...
\item 
void \mbox{\hyperlink{mcmc__sampler_8h_afa5117c4dfe1ac8bd457fb7bee622c6f}{P\+T\+M\+C\+M\+C\+\_\+\+M\+H\+\_\+dynamic\+\_\+\+P\+T\+\_\+alloc\+\_\+uncorrelated\+\_\+internal\+\_\+driver}} (double $\ast$$\ast$output, int dimension, int N\+\_\+steps, int chain\+\_\+N, int max\+\_\+chain\+\_\+\+N\+\_\+thermo\+\_\+ensemble, int swp\+\_\+freq, int t0, int nu, int corr\+\_\+threshold, int corr\+\_\+segments, double corr\+\_\+converge\+\_\+thresh, double corr\+\_\+target\+\_\+ac, std\+::string chain\+\_\+distribution\+\_\+scheme, std\+::function$<$ double(double $\ast$, int $\ast$, int, int, void $\ast$)$>$ log\+\_\+prior, std\+::function$<$ double(double $\ast$, int $\ast$, int, int, void $\ast$)$>$ log\+\_\+likelihood, std\+::function$<$ void(double $\ast$, int $\ast$, int, double $\ast$$\ast$, int, void $\ast$)$>$fisher, void $\ast$$\ast$user\+\_\+parameters, int num\+Threads, bool pool, bool show\+\_\+prog, std\+::string statistics\+\_\+filename, std\+::string chain\+\_\+filename, std\+::string likelihood\+\_\+log\+\_\+filename, std\+::string checkpoint\+\_\+file)
...
\item 
void \mbox{\hyperlink{mcmc__sampler_8h_a74c970893516b24e60511fc41ad93708}{continue\+\_\+\+P\+T\+M\+C\+M\+C\+\_\+\+M\+H\+\_\+dynamic\+\_\+\+P\+T\+\_\+alloc\+\_\+uncorrelated}} (std\+::string checkpoint\+\_\+file\+\_\+start, double $\ast$$\ast$output, int N\+\_\+steps, int max\+\_\+chain\+\_\+\+N\+\_\+thermo\+\_\+ensemble, double $\ast$chain\+\_\+temps, int swp\+\_\+freq, int t0, int nu, int corr\+\_\+threshold, int corr\+\_\+segments, double corr\+\_\+converge\+\_\+thresh, double corr\+\_\+target\+\_\+ac, std\+::string chain\+\_\+distribution\+\_\+scheme, double($\ast$log\+\_\+prior)(double $\ast$param, int dimension, int chain\+\_\+id, void $\ast$parameters), double($\ast$log\+\_\+likelihood)(double $\ast$param, int dimension, int chain\+\_\+id, void $\ast$parameters), void($\ast$fisher)(double $\ast$param, int dimension, double $\ast$$\ast$fisher, int chain\+\_\+id, void $\ast$parameters), void $\ast$$\ast$user\+\_\+parameters, int num\+Threads, bool pool, bool show\+\_\+prog, std\+::string statistics\+\_\+filename, std\+::string chain\+\_\+filename, std\+::string likelihood\+\_\+log\+\_\+filename, std\+::string checkpoint\+\_\+file)
\item 
void \mbox{\hyperlink{mcmc__sampler_8h_aca0ec45aeec4fbd2af0a0b222eefe53a}{continue\+\_\+\+P\+T\+M\+C\+M\+C\+\_\+\+M\+H\+\_\+dynamic\+\_\+\+P\+T\+\_\+alloc\+\_\+uncorrelated}} (std\+::string checkpoint\+\_\+file\+\_\+start, double $\ast$$\ast$output, int N\+\_\+steps, int max\+\_\+chain\+\_\+\+N\+\_\+thermo\+\_\+ensemble, double $\ast$chain\+\_\+temps, int swp\+\_\+freq, int t0, int nu, int corr\+\_\+threshold, int corr\+\_\+segments, double corr\+\_\+converge\+\_\+thresh, double corr\+\_\+target\+\_\+ac, std\+::string chain\+\_\+distribution\+\_\+scheme, double($\ast$log\+\_\+prior)(double $\ast$param, int dimension, void $\ast$parameters), double($\ast$log\+\_\+likelihood)(double $\ast$param, int dimension, void $\ast$parameters), void($\ast$fisher)(double $\ast$param, int dimension, double $\ast$$\ast$fisher, void $\ast$parameters), void $\ast$$\ast$user\+\_\+parameters, int num\+Threads, bool pool, bool show\+\_\+prog, std\+::string statistics\+\_\+filename, std\+::string chain\+\_\+filename, std\+::string likelihood\+\_\+log\+\_\+filename, std\+::string checkpoint\+\_\+file)
\item 
void \mbox{\hyperlink{mcmc__sampler_8h_a5d33cf90836be53bbedcc7d09f62911b}{continue\+\_\+\+P\+T\+M\+C\+M\+C\+\_\+\+M\+H\+\_\+dynamic\+\_\+\+P\+T\+\_\+alloc\+\_\+uncorrelated\+\_\+internal}} (std\+::string checkpoint\+\_\+file\+\_\+start, double $\ast$$\ast$output, int N\+\_\+steps, int max\+\_\+chain\+\_\+\+N\+\_\+thermo\+\_\+ensemble, double $\ast$chain\+\_\+temps, int swp\+\_\+freq, int t0, int nu, int corr\+\_\+threshold, int corr\+\_\+segments, double corr\+\_\+converge\+\_\+thresh, double corr\+\_\+target\+\_\+ac, std\+::string chain\+\_\+distribution\+\_\+scheme, std\+::function$<$ double(double $\ast$, int $\ast$, int, int, void $\ast$)$>$ log\+\_\+prior, std\+::function$<$ double(double $\ast$, int $\ast$, int, int, void $\ast$)$>$ log\+\_\+likelihood, std\+::function$<$ void(double $\ast$, int $\ast$, int, double $\ast$$\ast$, int, void $\ast$)$>$fisher, void $\ast$$\ast$user\+\_\+parameters, int num\+Threads, bool pool, bool show\+\_\+prog, std\+::string statistics\+\_\+filename, std\+::string chain\+\_\+filename, std\+::string likelihood\+\_\+log\+\_\+filename, std\+::string checkpoint\+\_\+file)
...
\item 
void \mbox{\hyperlink{mcmc__sampler_8h_a084c31ec2e87873946a4866b104fd733}{P\+T\+M\+C\+M\+C\+\_\+\+M\+H\+\_\+dynamic\+\_\+\+P\+T\+\_\+alloc\+\_\+uncorrelated\+\_\+internal}} (double $\ast$$\ast$output, int dimension, int N\+\_\+steps, int chain\+\_\+N, int max\+\_\+chain\+\_\+\+N\+\_\+thermo\+\_\+ensemble, double $\ast$initial\+\_\+pos, double $\ast$seeding\+\_\+var, double $\ast$chain\+\_\+temps, int swp\+\_\+freq, int t0, int nu, int corr\+\_\+threshold, int corr\+\_\+segments, double corr\+\_\+converge\+\_\+thresh, double corr\+\_\+target\+\_\+ac, std\+::string chain\+\_\+distribution\+\_\+scheme, std\+::function$<$ double(double $\ast$, int $\ast$, int, int, void $\ast$)$>$ log\+\_\+prior, std\+::function$<$ double(double $\ast$, int $\ast$, int, int, void $\ast$)$>$ log\+\_\+likelihood, std\+::function$<$ void(double $\ast$, int $\ast$, int, double $\ast$$\ast$, int, void $\ast$)$>$fisher, void $\ast$$\ast$user\+\_\+parameters, int num\+Threads, bool pool, bool show\+\_\+prog, std\+::string statistics\+\_\+filename, std\+::string chain\+\_\+filename, std\+::string likelihood\+\_\+log\+\_\+filename, std\+::string checkpoint\+\_\+file)
\begin{DoxyCompactList}\small\item\em Parallel tempered, dynamic chain allocation M\+C\+MC with output samples with specified maximum autocorrelation. \end{DoxyCompactList}\item 
\mbox{\Hypertarget{mcmc__sampler_8h_a86cd71b2998bae1bec6d5ced831a1446}\label{mcmc__sampler_8h_a86cd71b2998bae1bec6d5ced831a1446}} 
...
void \mbox{\hyperlink{mcmc__sampler_8h_ab4fc446d8f455eb4d4a7bfbf24dd1560}{continue\+\_\+\+P\+T\+M\+C\+M\+C\+\_\+\+M\+H\+\_\+internal}} (\mbox{\hyperlink{classsampler}{sampler}} $\ast$samplerptr, std\+::string start\+\_\+checkpoint\+\_\+file, double $\ast$$\ast$$\ast$output, int N\+\_\+steps, int swp\+\_\+freq, std\+::function$<$ double(double $\ast$, int $\ast$, int, int, void $\ast$)$>$ log\+\_\+prior, std\+::function$<$ double(double $\ast$, int $\ast$, int, int, void $\ast$)$>$ log\+\_\+likelihood, std\+::function$<$ void(double $\ast$, int $\ast$, int, double $\ast$$\ast$, int, void $\ast$)$>$fisher, void $\ast$$\ast$user\+\_\+parameters, int num\+Threads, bool pool, bool show\+\_\+prog, std\+::string statistics\+\_\+filename, std\+::string chain\+\_\+filename, std\+::string auto\+\_\+corr\+\_\+filename, std\+::string likelihood\+\_\+log\+\_\+filename, std\+::string end\+\_\+checkpoint\+\_\+file)
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{mcmc__sampler_8h_a74c970893516b24e60511fc41ad93708}\label{mcmc__sampler_8h_a74c970893516b24e60511fc41ad93708}} 
\index{mcmc\_sampler.h@{mcmc\_sampler.h}!continue\_PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated@{continue\_PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated}}
\index{continue\_PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated@{continue\_PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated}!mcmc\_sampler.h@{mcmc\_sampler.h}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{mcmc__sampler_8h_aca0ec45aeec4fbd2af0a0b222eefe53a}\label{mcmc__sampler_8h_aca0ec45aeec4fbd2af0a0b222eefe53a}} 
\index{mcmc\_sampler.h@{mcmc\_sampler.h}!continue\_PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated@{continue\_PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated}}
\index{continue\_PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated@{continue\_PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated}!mcmc\_sampler.h@{mcmc\_sampler.h}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{mcmc__sampler_8h_a5d33cf90836be53bbedcc7d09f62911b}\label{mcmc__sampler_8h_a5d33cf90836be53bbedcc7d09f62911b}} 
\index{mcmc\_sampler.h@{mcmc\_sampler.h}!continue\_PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated\_internal@{continue\_PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated\_internal}}
\index{continue\_PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated\_internal@{continue\_PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated\_internal}!mcmc\_sampler.h@{mcmc\_sampler.h}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{mcmc__sampler_8h_ab4fc446d8f455eb4d4a7bfbf24dd1560}\label{mcmc__sampler_8h_ab4fc446d8f455eb4d4a7bfbf24dd1560}} 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{mcmc__sampler_8h_a084c31ec2e87873946a4866b104fd733}\label{mcmc__sampler_8h_a084c31ec2e87873946a4866b104fd733}} 
\index{mcmc\_sampler.h@{mcmc\_sampler.h}!PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated\_internal@{PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated\_internal}}
\index{PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated\_internal@{PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated\_internal}!mcmc\_sampler.h@{mcmc\_sampler.h}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{mcmc__sampler_8h_afa5117c4dfe1ac8bd457fb7bee622c6f}\label{mcmc__sampler_8h_afa5117c4dfe1ac8bd457fb7bee622c6f}} 
\index{mcmc\_sampler.h@{mcmc\_sampler.h}!PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated\_internal\_driver@{PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated\_internal\_driver}}
\index{PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated\_internal\_driver@{PTMCMC\_MH\_dynamic\_PT\_alloc\_uncorrelated\_internal\_driver}!mcmc\_sampler.h@{mcmc\_sampler.h}}
