...
int \mbox{\hyperlink{mcmc__sampler__internals_8h_aecfd6c1ef213a233c95a98ae87897123}{chain\+\_\+number\+\_\+from\+\_\+checkpoint\+\_\+file}} (std\+::string check\+\_\+file, int $\ast$chain\+\_\+N)
\begin{DoxyCompactList}\small\item\em Load chain number from checkpoint file. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{mcmc__sampler__internals_8h_ac2b9f96c0359f9653c6b063b2f356b92}{dimension\+\_\+from\+\_\+checkpoint\+\_\+file}} (std\+::string check\+\_\+file, int $\ast$min\+\_\+dimension, int $\ast$max\+\_\+dimension)
\begin{DoxyCompactList}\small\item\em Load dimension from checkpoint file. \end{DoxyCompactList}\item 
...
void \mbox{\hyperlink{mcmc__sampler__internals_8h_af7d9266e3f9b69568a983b29e629ca98}{initiate\+\_\+full\+\_\+sampler}} (\mbox{\hyperlink{classsampler}{sampler}} $\ast$sampler\+\_\+new, \mbox{\hyperlink{classsampler}{sampler}} $\ast$sampler\+\_\+old, int chain\+\_\+\+N\+\_\+thermo\+\_\+ensemble, int chain\+\_\+N, std\+::string chain\+\_\+allocation\+\_\+scheme, std\+::string checkpoint\+\_\+file\+\_\+start)
...
void \mbox{\hyperlink{mcmc__sampler__internals_8h_a036d12e6378958e6b373866894a1081d}{copy\+\_\+base\+\_\+checkpoint\+\_\+properties}} (std\+::string check\+\_\+file, \mbox{\hyperlink{classsampler}{sampler}} $\ast$samplerptr)
\begin{DoxyCompactList}\small\item\em Copies positions and histories into chain ensemble, skipping the first set of temperatures. \end{DoxyCompactList}\item 
...
Type 3\+: Fisher step \mbox{\Hypertarget{mcmc__sampler__internals_8h_aecfd6c1ef213a233c95a98ae87897123}\label{mcmc__sampler__internals_8h_aecfd6c1ef213a233c95a98ae87897123}} 
\index{mcmc\_sampler\_internals.h@{mcmc\_sampler\_internals.h}!chain\_number\_from\_checkpoint\_file@{chain\_number\_from\_checkpoint\_file}}
\index{chain\_number\_from\_checkpoint\_file@{chain\_number\_from\_checkpoint\_file}!mcmc\_sampler\_internals.h@{mcmc\_sampler\_internals.h}}
\doxysubsubsection{\texorpdfstring{chain\_number\_from\_checkpoint\_file()}{chain\_number\_from\_checkpoint\_file()}}
{\footnotesize\ttfamily int chain\+\_\+number\+\_\+from\+\_\+checkpoint\+\_\+file (\begin{DoxyParamCaption}\item[{std\+::string}]{check\+\_\+file,  }\item[{int $\ast$}]{chain\+\_\+N }\end{DoxyParamCaption})}



Load chain number from checkpoint file. 

\mbox{\Hypertarget{mcmc__sampler__internals_8h_ae328d199338081b9affb09d1f8e71351}\label{mcmc__sampler__internals_8h_ae328d199338081b9affb09d1f8e71351}} 
...
Just loops through the ref\+\_\+chain\+\_\+status variables \mbox{\Hypertarget{mcmc__sampler__internals_8h_a036d12e6378958e6b373866894a1081d}\label{mcmc__sampler__internals_8h_a036d12e6378958e6b373866894a1081d}} 
\index{mcmc\_sampler\_internals.h@{mcmc\_sampler\_internals.h}!copy\_base\_checkpoint\_properties@{copy\_base\_checkpoint\_properties}}
\index{copy\_base\_checkpoint\_properties@{copy\_base\_checkpoint\_properties}!mcmc\_sampler\_internals.h@{mcmc\_sampler\_internals.h}}
\doxysubsubsection{\texorpdfstring{copy\_base\_checkpoint\_properties()}{copy\_base\_checkpoint\_properties()}}
{\footnotesize\ttfamily void copy\+\_\+base\+\_\+checkpoint\+\_\+properties (\begin{DoxyParamCaption}\item[{std\+::string}]{check\+\_\+file,  }\item[{\mbox{\hyperlink{classsampler}{sampler}} $\ast$}]{samplerptr }\end{DoxyParamCaption})}
...
{\itshape N\+O\+TE} -- sampler-\/$>$chain\+\_\+temps allocated internally -- M\+U\+ST free manually

!\+A\+S\+S\+U\+M\+P\+T\+I\+O\+N\+S! -- \begin{DoxyVerb}The checkpoint file and new sampler must have the same total number of chains, dimension, and the histories are the same length

The temperatures are in ascending order, as output in write_checkpoint
\end{DoxyVerb}
 \mbox{\Hypertarget{mcmc__sampler__internals_8h_ab2a990fd673ce479819a75cf5617c6b3}\label{mcmc__sampler__internals_8h_ab2a990fd673ce479819a75cf5617c6b3}} 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{mcmc__sampler__internals_8h_ac2b9f96c0359f9653c6b063b2f356b92}\label{mcmc__sampler__internals_8h_ac2b9f96c0359f9653c6b063b2f356b92}} 
\index{mcmc\_sampler\_internals.h@{mcmc\_sampler\_internals.h}!dimension\_from\_checkpoint\_file@{dimension\_from\_checkpoint\_file}}
\index{dimension\_from\_checkpoint\_file@{dimension\_from\_checkpoint\_file}!mcmc\_sampler\_internals.h@{mcmc\_sampler\_internals.h}}
\doxysubsubsection{\texorpdfstring{dimension\_from\_checkpoint\_file()}{dimension\_from\_checkpoint\_file()}}
{\footnotesize\ttfamily int dimension\+\_\+from\+\_\+checkpoint\+\_\+file (\begin{DoxyParamCaption}\item[{std\+::string}]{check\+\_\+file,  }\item[{int $\ast$}]{min\+\_\+dimension,  }\item[{int $\ast$}]{max\+\_\+dimension }\end{DoxyParamCaption})}



Load dimension from checkpoint file. 

If RJ -- returns min\+\_\+dimension and max\+\_\+dimension

If not RJ -- returns dimension in min\+\_\+dimension and max\+\_\+dimension \mbox{\Hypertarget{mcmc__sampler__internals_8h_a4f2eee3801304ac71a4f4dc03a7783a4}\label{mcmc__sampler__internals_8h_a4f2eee3801304ac71a4f4dc03a7783a4}} 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{mcmc__sampler__internals_8h_af7d9266e3f9b69568a983b29e629ca98}\label{mcmc__sampler__internals_8h_af7d9266e3f9b69568a983b29e629ca98}} 
...
{\footnotesize\ttfamily void initiate\+\_\+full\+\_\+sampler (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classsampler}{sampler}} $\ast$}]{sampler\+\_\+new,  }\item[{\mbox{\hyperlink{classsampler}{sampler}} $\ast$}]{sampler\+\_\+old,  }\item[{int}]{chain\+\_\+\+N\+\_\+thermo\+\_\+ensemble,  }\item[{int}]{chain\+\_\+N,  }\item[{std\+::string}]{chain\+\_\+allocation\+\_\+scheme,  }\item[{std\+::string}]{checkpoint\+\_\+file\+\_\+start }\end{DoxyParamCaption})}
...
checkpoint\+\_\+file\+\_\+start is the file used for continue\+\_\+\+P\+T\+M\+C\+MC like functions, and can be used if the user wants to maintain the approximate positions and histories of the ensemble of chains after the dynamic temperature allocation. If the rest of the chains should just be copies of the base ensemble, pass an empty string (\char`\"{}\char`\"{}). Since the chain distribution can change the number and distribution of chain temperatures (that\textquotesingle{}s kinda the point..), the transfer is not perfect. Cold chains are prioritized, then the rest of the chains are filled in as close as possible. 
\begin{DoxyParams}{Parameters}
...
\hline
{\em checkpoint\+\_\+file\+\_\+start} & Base checkpoint file \\
\hline
\end{DoxyParams}
