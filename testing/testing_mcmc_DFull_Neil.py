...
data = np.loadtxt("data/mcmc_output_DFull_Neil.csv",delimiter=',')
#data = data[10000:]
...
plt.savefig("mcmc_testing_DFull_Neil.pdf")
plt.close()
##############################################################
data = np.loadtxt("data/mcmc_output_DFull_hot_Neil.csv",delimiter=',')
#data = data[:-100]
...
figure = corner.corner(data, labels=labels,quantiles=[.16,.5,.84], show_titles=True)
plt.savefig("mcmc_testing_DFull_hot_Neil.pdf")
plt.close()

##############################################################
autocorr = np.loadtxt("data/auto_corr_mcmc_DFull_Neil.csv",delimiter=',')
lengths = autocorr[0]
autocorr = autocorr[1:]
...
plt.legend()
plt.savefig("autocorr_testing_DFull_Neil.pdf")
plt.close()
...
plt.savefig("mcmc_testing_transform_DFull_Neil.pdf")
plt.close()
