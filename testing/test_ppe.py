...
model = imrmod(mass1 = calculate_mass1(chirpm,eta)*s_solm, mass2 =calculate_mass2(chirpm,eta)*s_solm, spin1=-.2, spin2=.4, collision_phase=0, collision_time = 0., Luminosity_Distance=410*mpc, phase_mod=(2.5e5/3.e5)**4.)
