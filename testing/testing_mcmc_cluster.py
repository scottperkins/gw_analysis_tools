...
data = np.loadtxt("data/mcmc_output_cluster.csv",delimiter=',')
#data = data[1000:]
...
plt.savefig("mcmc_testing_cluster.pdf")
plt.close()
##############################################################
data = np.loadtxt("data/mcmc_output_cluster_hot.csv",delimiter=',')
#data = data[:-100]
...
figure = corner.corner(data, labels=labels,quantiles=[.16,.5,.84], show_titles=True)
plt.savefig("mcmc_testing_cluster_hot.pdf")
plt.close()

##############################################################
autocorr = np.loadtxt("data/auto_corr_mcmc_cluster.csv",delimiter=',')
lengths = autocorr[0]
autocorr = autocorr[1:]
...
plt.legend()
plt.savefig("autocorr_testing_cluster.pdf")
plt.close()
...
plt.savefig("mcmc_testing_transform_cluster.pdf")
plt.close()
