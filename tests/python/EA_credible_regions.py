...
plt.axvline(minca,color='r', label="68% credible region:({:0.2},{:0.2})".format(minca, maxca))
plt.axvline(maxca,color='r')

plt.legend(loc="upper right")
plt.title(r'$c_a$', fontsize=20)
plt.savefig("plots/credible_region_ca")
plt.close()
...
plt.axvline(minctheta,color='r', label="68% credible region:({:0.2},{:0.2})".format(minctheta, maxctheta))
plt.axvline(maxctheta,color='r')
plt.legend(loc="upper right")
plt.title(r'$c_\theta$', fontsize=20)
plt.savefig("plots/credible_region_ctheta")
plt.close()
...
plt.savefig("plots/credible_region_cw")
plt.close()
...
plt.savefig("plots/credible_region_csigma")
plt.close()
