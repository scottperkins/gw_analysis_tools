...
data_inv_PN = np.loadtxt("data/Tbm_times_inv_PN.csv",delimiter=',',unpack=True)
...
plt.plot(data_inv_PN[0],data_inv_PN[1]/T+.1,linestyle='-.',label="PN")
plt.yscale('log')
plt.xscale('log')
plt.xlabel("Freqs")
plt.ylabel("Times")
...
plt.loglog(data_inv_PN[1]/T,resid_PN/data_base[0],label="PN")
plt.legend()
