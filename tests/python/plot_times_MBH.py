...
plt.loglog(data1[0],data1[1]/T*365+400,label="0PN")
plt.loglog(data2[0],data2[1]/T*365+400,label="AD")
plt.loglog(data3[0],data3[1]/T*365+400,label="N")
plt.legend()
plt.xlabel("freqs")
...
#plt.plot(data1[1]/T,(data3[1]-data2[1])*2/(abs(data3[1])+abs(data2[1])),label="0pnAD")
#plt.plot(data1[1]/T,(data3[1]-data1[1])*2/(abs(data3[1])+abs(data1[1])),label="0pnN")
