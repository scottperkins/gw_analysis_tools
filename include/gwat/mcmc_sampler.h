...
void RJPTMCMC_MH_dynamic_PT_alloc_comprehensive_internal_driver(mcmc_sampler_output *sampler_output,
	...
	std::function<void(double*,double*,int*,int*,int *,int *,double*,mcmc_data_interface *, void *)> RJ_proposal,
...
void RJPTMCMC_MH(double ***output, 
	...
	void(*RJ_proposal)(double *current_param, double *proposed_param, int *current_status, int *proposed_status,int *current_model_status, int *proposed_model_status, double *MH_corrections,mcmc_data_interface *, void *parameters),
	void ** user_parameters,
	int numThreads, 
	bool pool, 
	bool show_prog, 
